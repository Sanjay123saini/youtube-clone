...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=all+time+favorite+movies&key=AIzaSyA00OxUbfdfVAjHn-9l48s0t-n_j7CBbNs&maxResults=6`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyA00OxUbfdfVAjHn-9l48s0t-n_j7CBbNs&maxResults=6`);
let data = await res.json();
